...
public class ObjectMergeConfig : EditorWindow {
	// GUI Settings
	...
	public const float margin = 112;			//Amount of extra space
	public static float midWidth = 25;

	RectOffset customStylePadding = new RectOffset(0, 0, 10, 5);
	Vector2 scroll;
	[MenuItem("Window/UniMerge/UniMerge Config")]
	static void Init() {
		EditorWindow.GetWindow(typeof(ObjectMergeConfig));
	}
	void OnGUI() {
		//Ctrl + w to close
		...
		GUISkin defaultSkin = AssetDatabase.LoadAssetAtPath(ObjectMergeConfig.DEFAULT_PATH + "/" + DEFAULT_GUI_SKIN_FILENAME, typeof(GUISkin)) as GUISkin;
		if(defaultSkin) {
			...
			defaultSkin.customStyles[0].padding = customStylePadding;		
			defaultSkin.customStyles[1].name = LIST_ALT_STYLE_NAME;
			defaultSkin.customStyles[1].padding = customStylePadding;
			defaultSkin.customStyles[2].name = LIST_STYLE_NAME + CONFLICT_SUFFIX;
			defaultSkin.customStyles[2].padding = customStylePadding;
			defaultSkin.customStyles[3].name = LIST_ALT_STYLE_NAME + CONFLICT_SUFFIX;
			defaultSkin.customStyles[3].padding = customStylePadding;
		...
		GUISkin darkSkin = AssetDatabase.LoadAssetAtPath(ObjectMergeConfig.DEFAULT_PATH + "/" + DARK_GUI_SKIN_FILENAME, typeof(GUISkin)) as GUISkin;
		if(darkSkin) {
			...
			darkSkin.customStyles[0].padding = customStylePadding;
			darkSkin.customStyles[1].name = LIST_ALT_STYLE_NAME;
			darkSkin.customStyles[1].padding = customStylePadding;
			darkSkin.customStyles[2].name = LIST_STYLE_NAME + CONFLICT_SUFFIX;
			darkSkin.customStyles[2].padding = customStylePadding;
			darkSkin.customStyles[3].name = LIST_ALT_STYLE_NAME + CONFLICT_SUFFIX;
			darkSkin.customStyles[3].padding = customStylePadding;
